 ...
 */
export const renderCourses = function(renderElementClassName, courses, wrapperClass = null) {
    ...
    courses.forEach(course => {
        ...
        const card = courseCardGenerator(createdAt, description, id, image, courseName, rating);
